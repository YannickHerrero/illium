    ...
    pub fn model(self, size: Size) -> Model {
        ...
        match self {
            Self::Build => output.push_str(concat!(
                "\x1b[36m demo@illium\x1b[0m \x1b[34m~/projects/hello-rust\x1b[0m\r\n",
                " $ cargo build --release\r\n\r\n",
            ...
            Self::Fetch => {
                output.push_str(concat!(
                    "\x1b[36m  /\\    /\\     \x1b[1mdemo@illium\x1b[0m\r\n",
                    "\x1b[36m /  \\  /  \\    \x1b[0m-------------\r\n",
                    "\x1b[36m \\   \\/   /    \x1b[34mOS\x1b[0m       Windows 11\r\n",
                    "\x1b[36m  \\      /     \x1b[34mDesktop\x1b[0m  Illium\r\n",
                    "\x1b[36m   \\ /\\ /      \x1b[34mTerminal\x1b[0m Illium Terminal\r\n",
...
mod tests {
    ...
    fn fixtures_are_stable_and_have_no_cursor_or_clipboard_output() {
        for scene in [Scene::Build, Scene::Fetch] {
            ...
            assert!(text.contains("demo@illium"));
